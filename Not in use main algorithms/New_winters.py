        ...
        while x <= 1:
            ...
            while y <= 0.1:
                ...
                while z <= 1:
                    ...
                    self.data_to_forecast = self.past_data[0:2400]
                    self.correct_data = self.past_data[2400:2400+self.forecast_length]

                    self.smooth_past_data()

                    mserrors.append(mse(self.forecast_data,self.correct_data))
        print(mserrors)
